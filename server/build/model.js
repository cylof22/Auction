...
var Product = /** @class */ (function () {
    function Product(id, title, price, rating, description, url, categories) {
        this.id = id;
        this.title = title;
        this.price = price;
        this.rating = rating;
...
var products = [
    new Product(0, 'First Product', 24.99, 4.3, 'This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', "http://localhost:8080/outputs/16-output.jpg", ['electronics', 'hardware']),
    {
        "id": 1,
        ...
        "url": "http://localhost:8080/outputs/11-output.jpg",
        "categories": ["books"]
    },
    {
        "id": 2,
        ...
        "rating": 4.2,
        "description": "This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        "url": "http://localhost:8080/outputs/12-output.jpg",
    ...
    },
    {
        ...
        "rating": 3.9,
        "description": "This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        "url": "http://localhost:8080/outputs/13-output.jpg",
        "categories": ["hardware"]
    },
    {
        "id": 4,
        ...
        "rating": 5,
        "description": "This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        "url": "http://localhost:8080/outputs/14-output.jpg",
    ...
    },
    {
        ...
        "rating": 4.6,
        "description": "This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
        "url": "http://localhost:8080/outputs/15-output.jpg",
        "categories": ["books"]
    }
];
var reviews = [
